...
public final class MessageSenderServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.src.grpc.generated.SendRequest,
      com.src.grpc.generated.Response> getSendMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "send",
      requestType = com.src.grpc.generated.SendRequest.class,
      responseType = com.src.grpc.generated.Response.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.src.grpc.generated.SendRequest,
      com.src.grpc.generated.Response> getSendMethod() {
    io.grpc.MethodDescriptor<com.src.grpc.generated.SendRequest, com.src.grpc.generated.Response> getSendMethod;
      ...
      synchronized (MessageSenderServiceGrpc.class) {
        if ((getSendMethod = MessageSenderServiceGrpc.getSendMethod) == null) {
          MessageSenderServiceGrpc.getSendMethod = getSendMethod = 
              io.grpc.MethodDescriptor.<com.src.grpc.generated.SendRequest, com.src.grpc.generated.Response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "MessageSenderService", "send"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.src.grpc.generated.SendRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.src.grpc.generated.Response.getDefaultInstance()))
  ...
  public static abstract class MessageSenderServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void send(com.src.grpc.generated.SendRequest request,
        io.grpc.stub.StreamObserver<com.src.grpc.generated.Response> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.src.grpc.generated.SendRequest,
                com.src.grpc.generated.Response>(
                  this, METHODID_SEND)))
          .build();
    }
  }
  ...
  public static final class MessageSenderServiceBlockingStub extends io.grpc.stub.AbstractStub<MessageSenderServiceBlockingStub> {
    ...
    /**
     */
    public com.src.grpc.generated.Response send(com.src.grpc.generated.SendRequest request) {
  ...
  public static final class MessageSenderServiceFutureStub extends io.grpc.stub.AbstractStub<MessageSenderServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.src.grpc.generated.Response> send(
        com.src.grpc.generated.SendRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND:
          serviceImpl.send((com.src.grpc.generated.SendRequest) request,
              (io.grpc.stub.StreamObserver<com.src.grpc.generated.Response>) responseObserver);
          break;
        default:
  ...
  private static abstract class MessageSenderServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.src.grpc.generated.MessageService.getDescriptor();
    }
